...
function bookCreate(title, summary, isbn, author, subject, cb) {
  bookdetail = { 
    title: title,
    summary: summary,
    author: author,
  ...
  if (subject != false) bookdetail.subject = subject
...
function createSubjectAuthors(cb) {
    async.series([
        function(callback) {
        ...
        function(callback) {
          subjectCreate("Fantasy", callback);
        },
        function(callback) {
          subjectCreate("Science Fiction", callback);
        },
        function(callback) {
          subjectCreate("French Poetry", callback);
        },
        ],
        // optional callback
        cb);
